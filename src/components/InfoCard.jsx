function InfoCard({ earthquake, onClose }) {
  ...
  return (
    <div className="absolute top-20 right-6 bg-white rounded-lg shadow-2xl p-5 max-w-sm z-[1000] border border-gray-200 md:top-6">
      <div className="flex justify-between items-start mb-3">
        <h3 className="font-bold text-lg text-gray-800">Earthquake Details</h3>
        <button
          onClick={onClose}
      ...
      <div className="space-y-3">
        ...
        <div>
          <p className="text-sm font-semibold text-gray-600 mb-1">Magnitude</p>
          <p 
        ...
        {earthquake.depth != null && (
          <div>
            <p className="text-sm font-semibold text-gray-600 mb-1">Depth</p>
        ...
        {earthquake.url && (
          <div className="pt-3 border-t border-gray-200">
            <a
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
            >
              <span>🔗</span>
              <span>More Info</span>
